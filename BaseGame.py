...
name = input (" Aub voeg eve u naam?: ")
turn = first_go
player = player()
Computer = player
...
while player_hp > 0 and Computer_hp > 0:
    print(f"\n{turn}'s turn")
    if turn != 'Computer':
        action = int(input(f"{name}, Aub neem u een actie:\n1)Normal Attack\n2) Special Attack\n3) heal\n"))
        if action == 1:
            ...
            time.sleep(2)
            print(f"The Computer nu heeft {Computer_hp} health en {Computer_energy} energy")
            turn = 'Computer'
        ...
        if Computer_hp < 50 and Computer_energy >=15:
            ...
            time.sleep(1)
            print(f"De computer heeft nu {Computer_hp} hp en {Computer_energy} energy ")
            turn = name
        if Computer_energy >= 20:
            ...
            print(f" The computer heeft nu { Computer_hp} hp and {Computer_energy}")
            turn = name
